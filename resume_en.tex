...
\tldatecventry{2017}{Internship - iOS engineer \faApple}{Care Labs}{Montpellier, France}{\url{www.carelabs.co}}{The \textit{CareBook} app is a personal health book, allowing to view its appointments, store its documents or update its medical record. My assignment was the complete design of the app: UX, development, tests and roll out. Available early September 2017.
}
